...
Smart Context という機能ですが、要は「生成 AI が理解しやすい形式に変換した "ページ内容"」です。URL として生成してもいいですし、直接ダウンロードしても構いません。今回はダウンロードにしましょう:
...
2 hop は紛らわしいのですが、図で言えばオレンジだけです。
...
### 聞き方：渡した上で何を尋ねるか
ローデンのコンテンツを Export For AI で出して、生成 AI に渡しました。では何を尋ねればいいのでしょうか。
...
渡しやすく
ローデンにできるだけ書くようにする
とにかく export for ai を使う経験を積む、なれろ
ダウンロード先にすぐアクセスできるように: フォルダか、あるいはブラウザから

聞きやすく
質問のテンプレを用意しておいて、コピペで済むようにする
辞書変換、定型文コピー、これでいいだろ: わからなければ、この記事内容をコピペして生成AIに聞け
