...
私の例で言えば、以下のように創作（ライトノベルかつ男性読者向けなので見苦しさはご勘弁ください）ネタはなるべく書いていますし、

![](images/260612_061211.png)

こちらはほぼ妄想になりますが、SNS を考えるのも好きなのでよくまとめています:
...
たとえば既存のクラウドストレージが検閲を行っていることは知られていて、違法と判定されたファイルと同じハッシュ（ファイルから一意につくれる ID）のファイルがあったらブロックとか、我が子の写真がポルノ認定されてアカウントが BAN されたといった事例もあるようです。また、あまり縁がないかもしれませんが、R-18 の創作を行うクリエイターも結構この手の問題に悩まされるようです。

Cosense がどのようなポリシーで運用しているかはわかりませんが、利用規約は上記のとおりです。
